...
const DetailsTabItems = ({courseData}) => {
   const { id, name, slug, type, language, publishers, categories, modules, tags, translations, image, url, duration_avg, rating_avg, ratings_count, primary_cip_code, secondary_cip_code, published_at, created_at, updated_at } = courseData;
