                ...
                <section className="section-box">
                    <div className=" banner-hero bg-img-calculator">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-6 mt-20 mb-20">
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <div className="row mt-50">
                                <div className="col-lg-6 col-md-12 col-sm-12 pr-60">
                                    <h3 className="mt-5">Using the R&D Tax Credit Scheme</h3>
                                    <div className="mt-20">
                                        <h6 className="mt-20"><strong>Nearly £84 billion of R&D tax relief is unclaimed in the UK according to the Treasury.</strong></h6>
                                        <p className="font-md color-text-paragraph mt-20">With 80% of eligible businesses not having made a claim, use our simple calculator to see if you may qualify. To claim you need to explain how a project: looked for an advance in the field, had to overcome the scientific or technological uncertainty, tried to overcome the scientific or technological uncertainty, could not be easily worked out by a professional in the field.</p>
                                        <p className="font-md color-text-paragraph mt-20 mb-20">Watch this simple video to learn more about how the scheme can be used.</p>
                                    </div>
                                    <div className="mt-30 mb-30" style={{display: start ? "block" : "none"}}>
                                        <button className="btn btn-default fs-6" onClick={toggleOpen}>Get Started</button>
                                    </div>
                                </div>
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <div className="row mt-30">
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12 pl-50">
                                    <h3 className="mt-15">Examples of R&D tax credit claims</h3>
                                    <div className="mt-20">
                                        <p className="font-md fw-bold color-text-paragraph mt-20">Size of your claim will depend on the scale of your R&D activity and your costs.</p>
                                        <p className="font-md color-text-paragraph mt-20"><span className="fw-bold" style={{color: "#1740d0"}}>A profitable SME:</span> In addition to the tax relief your company’s eligible R&D expenditure generates, a further 86% can be deducted from the yearly profit. If you spent £500,000 per year on R&D you could potentially claim back up to £107,500 as a tax refund or reduced tax liability.</p>
                                        <p className="font-md color-text-paragraph mt-20"><span className="fw-bold" style={{color: "#f58a3c"}}>A loss-making SME: </span>A payable credit can be claimed by loss-making SMEs. With an R&D tax credit incentive of up to 18.6%, if a company spent £500,000 per year on R&D it could potentially claim back up to £93,000.</p>
                                        <p className="font-md color-text-paragraph mt-20"><span className="fw-bold" style={{color: "#3aab67"}}>A loss-making, R&D intensive SME: </span>At least 40% of a company’s total expenditure being spent on R&D. Businesses in this category may be eligible for up to 27%. If you spent £500,000 per year on R&D you could potentially claim back up to £135,000.</p>
                                    </div>
                                    <div className="mt-30" style={{display: start ? "block" : "none"}}>
                                        <button className="btn btn-default fs-6" onClick={toggleOpen}>Get Started</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <div className="row mt-10">
                                <div className="col-lg-6 col-md-12 col-sm-12 pt-40 pl-60 pr-60">
                                    <h3 className="mt-15">Encouraging Innovation</h3>
                                    <div className="mt-40">
                                    ...
                                    <div className="mt-40 mb-30" style={{display: start ? "block" : "none"}}>
                                        <button className="btn btn-default fs-6" onClick={toggleOpen}>Get Started</button>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pl-50">
                                    ...
                                    <div className="mt-20">
                                        <h6 className="font-md fw-bold color-text-paragraph mt-20" style={{color: "#1740d0"}}>Calculating R&D tax credits for SMEs</h6>
                                        ...
                                        <h6 className="font-md fw-bold color-text-paragraph mt-20" style={{color: "#3aab67"}}>Changes to R&D tax credit scheme</h6>
                                        ...
                                        <h6 className="font-md fw-bold color-text-paragraph mt-20" style={{color: "#f58a3c"}}>Calculating R&D tax credits for SMEs</h6>
                                        <p className="font-md color-text-paragraph">To qualify as an SME, your company must have fewer than 500 staff and a turnover of under £100 million GBP’s or a balance sheet total under £86 million GBP’s.</p>
                                    </div>
                                    <div className="mt-30">
                        ...
                        <div className="container">
                            <div className="row mt-20">
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    <h3 className="mt-15">UK Government Website</h3>
                                    <div className="mt-20">
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12 mt-20">
                                    <img className="content-media" style={{"minWidth": "30vw"}} src="assets/imgs/page/r&d-tax-credits-calculator/Government.png" alt="joxBox" />
                                </div>
                            </div>
                        </div>
                    </div>
