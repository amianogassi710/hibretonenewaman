                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <Grid container className="mb-20" alignItems="center" style={{minWidth: '100%'}}
                                ...
                                <Grid item lg={6} className="mt-20" sx={{paddingRight: {lg: '40px'}}}>
                                    <h3>Using the R&D Tax Credit Scheme</h3>
                                    <div>
                                        <p className="mt-30"><strong>Nearly £84 billion of R&D tax relief is unclaimed in the UK according to the Treasury.</strong></p>
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <Grid container alignItems="center" style={{minWidth: '100%'}}
                                ...
                                <Grid item className="mt-30" lg={6} sx={{paddingLeft: {lg: '30px'}}}>
                ...
                <section className="section-box mt-40">
                    <div className="post-loop-grid">
                        <div className="container">
                            <Grid container alignItems="center" style={{minWidth: '100%'}}
                                    sx={{display: {xs: 'none', md: 'none', lg: 'flex'}}}>
                                <Grid  className="mt-40" item lg={6} sx={{paddingRight: {lg: '50px'}}}>
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            ...
                            <Grid container alignItems="center" style={{minWidth: '100%'}}
                                ...
                                <Grid item xs={12} md={12}>
                                    <div className="mt-10">
                                        <h6 className="fw-bold color-text-paragraph mt-5" style={{color: "#1740d0"}}>Calculating R&D tax credits for SMEs</h6>
                                        <p className="color-text-paragraph">To qualify as an SME, your company must have fewer than 500 staff and a turnover of under £100 million GBP’s or a balance sheet total under £86 million GBP’s.</p>
                                        <h6 className="fw-bold color-text-paragraph mt-5" style={{color: "#3aab67"}}>Changes to R&D tax credit scheme</h6>
                                        <p className="color-text-paragraph">The government makes ongoing reforms to R&D tax credit relief schemes. Contact a Preferred Partner tax advisor for the latest information.</p>
                                        <h6 className="fw-bold color-text-paragraph mt-5" style={{color: "#f58a3c"}}>Calculating R&D tax credits for SMEs</h6>
                                        <p className="color-text-paragraph">To qualify as an SME, your company must have fewer than 500 staff and a turnover of under £100 million GBP’s or a balance sheet total under £86 million GBP’s.</p>
                                    </div>
                ...
                <section className="section-box mt-40">
                    <div className="post-loop-grid">
                        <div className="container">
                            <Grid container alignItems="center" style={{minWidth: '100%'}}
                                    sx={{display: {xs: 'none', md: 'none', lg: 'flex'}}}>
                                <Grid item lg={6} sx={{paddingRight: {lg: '50px'}}}>
