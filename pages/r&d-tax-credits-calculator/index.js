                        ...
                        <div className="container">
                            <div className="row mt-50">
                                <div className="col-lg-6 col-md-12 col-sm-12 mt-20 pr-60">
                                    ...
                                    <div className="mt-10">
                                        <h6 className="mt-10 font-sm"><strong>Nearly £84 billion of R&D tax relief is unclaimed in the UK according to the Treasury.</strong></h6>
                            ...
                            <div className="row mt-30">
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12 pl-30 mt-10">
                                    ...
                                    <div className="mt-10">
                                        ...
                                        <p className="font-sm color-text-paragraph mt-10"><span className="fw-bold" style={{color: "#1740d0"}}>A profitable SME:</span> In addition to the tax relief your company’s eligible R&D expenditure generates, a further 86% can be deducted from the yearly profit. If you spent £500,000 per year on R&D you could potentially claim back up to £107,500 as a tax refund or reduced tax liability.</p>
                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pl-50">
                                    ...
                                    <div className="mt-10">
                                        <h6 className="font-sm fw-bold color-text-paragraph mt-5" style={{color: "#1740d0"}}>Calculating R&D tax credits for SMEs</h6>
                                        ...
                                        <h6 className="font-sm fw-bold color-text-paragraph mt-5" style={{color: "#3aab67"}}>Changes to R&D tax credit scheme</h6>
                        ...
                        <div className="container">
                            <div className="row mt-20">
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div className="mt-10">
                                        <p className="font-sm color-text-paragraph">Keep up to date with UK Government R&D Tax Credit schemes. Along with calculations, provides detailed information on what can be claimed and what cannot be claimed, if your advance is in the arts, humanities, social sciences, including economics.</p>
                                    </div>
