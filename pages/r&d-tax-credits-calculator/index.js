                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <div className="row mt-30">
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <iframe className="content-media" width="560" height="315" src="https://www.youtube.com/embed/-OinRckvals?si=TUyb8vFa2udkyE4S" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="post-loop-grid">
                        <div className="container">
                            <div className="row mt-50">
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12 pl-60 pr-60">
                        ...
                        <div className="container">
                            <div className="row mt-50">
                                <div className="col-lg-6 col-md-12 col-sm-12 pr-30">
                                    ...
                                    <div className="mt-20">
                                        <p className="font-md fw-bold color-text-paragraph mt-20">Size of your claim will depend on the scale of your R&D activity and your costs (Figures below are 2022-2023 tax year).</p>
                        ...
                        <div className="container">
                            <div className="row mt-50">
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div className="mt-20">
                                        <p className="font-md color-text-paragraph">UK Government encourages innovation as it is vital for improving the UK’s productivity, performance and competitiveness. Hence, research and development (R&D) incentives for small and medium size enterprises (SMEs) and large companies have been improved over several years to encourage and reward greater UK innovation.</p>
                                    </div>
                                    <div className="mt-30">
                                        <a className="btn btn-default fs-6" href="#">
                                            Read More
