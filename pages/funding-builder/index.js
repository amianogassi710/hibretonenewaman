                                        ...
                                        <div className="title-details">
                                            ...
                                            <p className="fundingbuilderparatext">
                                                {showMore1
                                                    ...
                                                    : "A Skynova study notes that 47% of startup failures in 2022 were due to a lack of financing, nearly double the percentage that."}
                                                <button
                                            ...
                                            <p className="fundingbuilderparatext">
                                                {showMore2
                                                    ...
                                                    : "Running a successful business requires more than just a great idea and a solid business plan. Adequate financing plays a crucial "}
                                                <button
                                                    className="btn-show-more"
                                                    onClick={() =>
                                                        setShowMore2(
                                            ...
                                            <p className="fundingbuilderparatext">
                                                {showMore3
                                                    ...
                                                    : "Due diligence. Making yourself stand out from the crowd is a must to ensure success! connect with the right partners"}
                                                <button
                                                    className="btn-show-more"
                                                    onClick={() =>
                                                        setShowMore3(
