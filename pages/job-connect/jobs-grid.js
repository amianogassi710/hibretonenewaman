...
export default function JobGrid() {
    ...
    useEffect(() => {
        const getJobs = async () => {
          try {
            const response = await axios.get(`/jobs/job-connect/get_list`)
                                                ...
                                                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <div className="card-grid-2 hover-up">
                                                        <div className="card-grid-2-image-left">
                                                            ...
                                                            <div className="right-info">
                                                                <Link legacyBehavior href="company-details">
                                                                    <a className="name-job" style={{"height": "50px"}}>{information.company_name}</a>
                                                                </Link>
                                                                <span className="location-small">{information.location}</span>
                                                            </div>
                                                        </div>
                                                        <div className="card-block-info">
                                                            ...
                                                            <div className="font-sm color-text-paragraph mt-15 mb-10" dangerouslySetInnerHTML={{ __html: information.description}} style={{"height": "100px", "overflow": "hidden"}}></div>
                                                            <a className="link"><span className="color-brand-2 fw-bolder">...more details</span></a>
                                                            <div className="mt-20">
                                                                {information.tags.map((tag) => (
                                                                    <Link legacyBehavior href="/jobs-grid">
                                                                        <a className="btn btn-grey-small mr-5">{tag}</a>
                                                                    </Link>
                                                                ))}
                                                            </div>
                                ...
                                <div className="col-lg-3 col-md-12 col-sm-12 col-12">
                                    <div className="sidebar-shadow none-shadow mb-30">
                                        <div className="sidebar-filters">
                                            ...
                                            <div className="filter-block mb-20">
                                                <h5 className="medium-heading mb-15">Organisation Type</h5>
                                                <div className="form-group">
                                                    <ul className="list-checkbox">
                                                        <li>
                                                            <label className="cb-container">
                                                        ...
                                                        <li>
                                                            <label className="cb-container">
                                                                <input type="checkbox" />
                                                                <span className="text-small">XXX</span>
                                                                <span className="checkmark" />
                                                            </label>
                                                            <span className="number-item">12</span>
                                                        </li>
                                            ...
                                            <div className="filter-block mb-20">
                                                <h5 className="medium-heading mb-15">Funding Type</h5>
                                                <div className="form-group">
                                                    <ul className="list-checkbox">
                                                        <li>
                                                            <label className="cb-container">
