                                                ...
                                                <div className="card-grid-2 hover-up">
                                                    <div className="card-grid-2-image-left">
                                                        ...
                                                        <div className="right-info">
                                                            ...
                                                            <span className="location-small">Location</span>
                                                        </div>
                                                    </div>
                                                    <div className="card-block-info">
                                                        ...
                                                        <div className="mt-5">
                                                            <span className="card-briefcase">Position Type</span>
                                                            <span className="card-time">
                                                                5<span> minutes ago</span>
                                                            </span>
                                                        </div>
                                                        <p className="font-sm color-text-paragraph mt-15">JOB DESCRIPTION:<br />Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                                                        <div className="mt-30">
                                                            <Link legacyBehavior href="/jobs-grid">
                                                                <a className="btn btn-grey-small mr-5">Skill 1</a>
                                                            </Link>

                                                            <Link legacyBehavior href="/jobs-grid">
                                                                <a className="btn btn-grey-small mr-5">Skill 2</a>
                                                            </Link>
                                                        </div>
