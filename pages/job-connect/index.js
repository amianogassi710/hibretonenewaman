                                                ...
                                                <div className="card-grid-2 hover-up">
                                                    <div className="card-grid-2-image-left">
                                                        ...
                                                        <div className="right-info">
                                                            <Link legacyBehavior href="company-details">
                                                                <a className="name-job">Corra Foundation</a>
                                                            </Link>
                                                    ...
                                                    <div className="card-block-info">
                                                        ...
                                                        <div className="mt-5">
                                                            ...
                                                            Closing date: <span> 07/02/2024</span>
                                                            </span>
                                                        </div>
                                                        <p className="font-sm color-text-paragraph mt-15">Towards the establishment of the Independent Human Rights Fund for Scotland.</p>
                                                        {/* <div className="mt-30">
                                                            <Link legacyBehavior href="/jobs-grid">
                                                        ...
                                                        <div className="card-2-bottom mt-30">
                                                            <div className="row">
                                                                <div className="col-lg-7 col-7">
                                                                    <span className="card-text-price">£100,000</span>
