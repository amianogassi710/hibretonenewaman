  ...
  const featuresData = [
    {
       ...
       text: "Better understand your skills & abilities for starting your own enterprise"
    },
    {
       id: 2,
       ...
       title: 'Enterprise',
       text: "Is your idea worth turning into a social enterprise or "
    },
    {
       id: 3,
       ...
       text: "Appreciating your neurodiversity traits can benefit starting a business"
    },
 ]
                  ...
                  <div className="row">
                     {
                        featuresData.map(feature => {
                           return <div key={feature.id} className="features-content col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                              <div className="d-sm-flex align-items-start white-bg mb-30">
                                 ...
                                 <div className="features__content">
                                    ...
                                    <Link href="/about">
                                       <p className="link-btn">Learn More <i className="fa-regular fa-arrow-right">
                                       </i></p>
                                    </Link>
                                 </div>
                              </div>
